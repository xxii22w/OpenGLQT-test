...
void Texture2SceenObject::create(QOpenGLShaderProgram* shaderProgramm)
{
...
void Texture2SceenObject::destroy() {
	m_vao.destroy();
	m_vbo.destroy();
}


void Texture2SceenObject::render() {
	m_vao.bind();
